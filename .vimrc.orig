...
""        color slate                 " Load a colorscheme
        "chagned  by tianyi above
""    endif
...
""        let g:solarized_visibility="high"
   ...
   "" hi PmenuSel ctermbg=DarkCyan guibg=white guifg=DarkCyan
   "" hi PmenuSbar ctermbg=DarkCyan guibg=white guifg=DarkCyan
    ""hi comment term=bold guifg=#000fff ctermfg=Cyan  gui=bold ctermbg=None guibg=None
...
" Plugins {
    ...
    " indent_guides {
        if !exists('g:spf13_no_indent_guides_autocolor')
            ...
            ""autocmd VimEnter,Colorscheme * :hi IndentGuidesOdd  guibg=#ff0000 ctermbg=3
            ""autocmd VimEnter,Colorscheme * :hi IndentGuidesEven guibg=#00ff00 ctermbg=2
        endif
